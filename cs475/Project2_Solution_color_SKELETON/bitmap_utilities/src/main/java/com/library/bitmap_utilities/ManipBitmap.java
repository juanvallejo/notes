...
public class ManipBitmap {
    ...
    protected static void threshold(Bitmap source ) {
        threshold(source, Lower1, Lower2, Color1, Color2, Color3);
	}
    ...
    protected static void threshold(Bitmap source, int lower1, int lower2, int color1, int color2, int color3 ) {
	   	if (source == null )
    		throw new NullPointerException();
