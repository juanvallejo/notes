...
public class ListPosTest {
    ...
    /**
     * does goPrev() simulate goTop if position is 1
     */
    @Test
    public void doesGoPrevGoToDummyHeadIfPositionIsOne() {
        ListPos list = new ListPos();
        list.insert(new Object());
        list.goPrev();
    ...
    /**
     * does go last go to last elt in mult elt list
     */
    @Test
    public void doesGoLastGoToLastElement() {
        ListPos list = new ListPos();
        list.insert(new Object());
        list.insert(new Object());
        list.insert(new Object());
